...
class Scratch {
    public static void main(String[] args) {
        ...
        System.out.println(Arrays.asList("com.zaxxer.hikari.HikariDataSource"));
        System.out.println(Arrays.asList(new String[]{"com.zaxxer.hikari.HikariDataSource", "javax.sql.DataSource"}));
    }
}